...
void DataManager::loadData(const string &filename, LogManager &logManager) const
{
    ...
    for (const auto &entry : data["logs"]) {
        ...
        QDateTime date = QDateTime::fromString(QString::fromStdString(
        ...
        if (logType == "Workout") {
            ...
            if (workoutType == "Cardio") {
                ...
                if (cardioType == "Distance") {
                    ...
                    logManager.addLog(make_unique<CardioWorkout>(logID,
                                                                 date,
                                                                 description,
                                                                 duration,
                                                                 caloriesBurned,
                ...
                logManager.addLog(make_unique<StrengthWorkout>(
                    logID, date, description, duration, caloriesBurned, sets, reps, weight));
                ...
                logManager.addLog(make_unique<YogaWorkout>(
                    logID, date, description, duration, caloriesBurned, style, intensity));
            }
            ...
            logManager.addLog(make_unique<Nutrition>(logID,
                                                     date,
                                                     description,
                                                     duration,
                                                     mealType,
